...
class IngredientType
{
    ...
    public function getIngredientTpName(): ?string
    {
        return $this->ingredientTpName;
    }

    public function setIngredientTpName(string $ingredientTpName): static
    {
        $this->ingredientTpName = $ingredientTpName;
